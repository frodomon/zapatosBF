 ...
 */
class Sxp_Spago_Block_Successfull extends Mage_Core_Block_Template
{
    /**
    ...
    {
        $I3 = hash_hmac("sha1",$idSocio.$numeroTransaccion,$this->getKeySocio());
        return $I3;
    }
