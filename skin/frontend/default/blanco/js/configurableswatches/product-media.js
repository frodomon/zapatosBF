...
var ConfigurableMediaImages = {
    ...
    updateImage: function(el) {
        ...
        var swatchImageSmallUrl = ConfigurableMediaImages.getSwatchImage(productId, label, selectedLabels, "small_image");
        if(!ConfigurableMediaImages.isValidImage(swatchImageSmallUrl)) {
            return;
        }

        var swatchImage = ConfigurableMediaImages.getImageObject(productId, swatchImageUrl);
        var swatchImageSmall = ConfigurableMediaImages.getImageObject(productId, swatchImageSmallUrl);

        ProductMediaManager.swapImage(swatchImage, swatchImageSmall);
    },
