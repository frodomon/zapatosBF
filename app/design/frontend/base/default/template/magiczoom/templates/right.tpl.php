...
?>
<!-- Begin magiczoom -->
<div class="MagicToolboxContainer selectorsRight" style="max-width: <?php echo ($wm + $ws + $m)?>px;padding-right:<?php echo $ws+$m; ?>px;">
    <?php if(count($thumbs) > 1):?>
    <div id="MagicToolboxSelectors<?php echo $pid?>" class="MagicToolboxSelectorsContainer<?php echo $magicscroll;?>" style="width: <?php echo $ws?>px;margin-right: -<?php echo $ws+$m; ?>px;">
        <?php echo join("\n\t",$thumbs)?>
    </div>
